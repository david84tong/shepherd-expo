...
import { ONBOARDING_PAGES, OnboardingResponse, OnboardingPageId, ONBOARDING_STORAGE_KEY, ONBOARDING_COMPLETED_KEY } from '../types/onboarding'
...
export const useOnboarding = () => {
  ...
  const handleResponse = useCallback(async (pageId: OnboardingPageId, value: OnboardingResponse[OnboardingPageId]) => {
    try {
