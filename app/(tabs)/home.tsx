...
// Backgrounds
const grassBg = require('../../assets/backgrounds/mainBackground.png');
...
export default function HomeScreen() {
  ...
  const lambTranslateY = Animated.add(
    ...
    previewAnim.interpolate({ inputRange: [0, 1], outputRange: [0, 100], extrapolate: 'clamp' }),
    Animated.add(
...
const styles = StyleSheet.create({
  ...
  bottomCard: {
    ...
    marginTop: -140, // Adjust overlap as needed
    shadowColor: "#000",
