...
const ONBOARDING_SCREENS: DebugScreen[] = [
  ...
  { name: 'Phone Number & OTP', route: '/onboarding/phoneNumber' },
  { name: 'Contacts Permission', route: '/onboarding/contacts' },
  { name: 'Already on Shepherd', route: '/onboarding/alreadyOnShepherd' },
