  ...
  const renderMoodScreen = () => {
    ...
    return (
      <Animated.View
        ...
        <Text className="font-feather text-2xl mt-2 text-textPrimary mb-2 text-center max-w-[340px]">
          How are you feeling right now?
        </Text>
        <Text className="font-feather text-lg mb-6 text-center px-1 text-textPrimary/70 max-w-[340px]">
  ...
  const renderFocusScreen = () => {
    ...
    return (
      <Animated.View
        ...
        <Text className="font-feather text-2xl mt-4 text-textPrimary mb-1 text-center">
          What would you like to focus on?
        </Text>
        <Text className="font-feather text-lg mb-6 text-center px-4 text-textPrimary/70">
  ...
  const renderStruggleScreen = () => {
    ...
    return (
      <Animated.View
        ...
        <Text className="font-feather text-2xl mt-6 text-textPrimary text-center px-2 mb-1">
          What are you struggling with?
        </Text>
        <Text className="font-feather text-lg text-center mb-6 text-textPrimary/70">
